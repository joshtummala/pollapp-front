...
const CreateQuestionModal = ({ group_id }: CreateQuestionModalType) => {
  ...
  const onChangeHandler = () => {
    ...
    createQuestion({
      ...
      setOptions([]);
      console.log(value);
      dispatch({ type: "SET_ADD_QUESTION" });
    });
  };
  return (
    <div
      className="modal fade"
      id="staticCreateQuestion"
      data-bs-backdrop="static"
      data-bs-keyboard="false"
      aria-labelledby="staticCreateQuestionLabel"
      aria-hidden="true"
    >
              ...
              <div className="my-4">
                ...
                <div className="input-group mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) => setOptionsOne(e.target.value)}
                    value={optionsOne}
                  />
                </div>
                <div className="input-group mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) => setOptionsTwo(e.target.value)}
                    value={optionsTwo}
                  />
                </div>
                ...
                <div className="input-group mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) => setOptionsThree(e.target.value)}
                    value={optionsThree}
                  />
                </div>
                <div className="input-group mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) => setOptionsFour(e.target.value)}
                    value={optionsFour}
                  />
                </div>
              </div>
