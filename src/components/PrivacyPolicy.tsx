...
const PrivacyPolicy = () => {
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to PollApp.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to PollApp, accessible from{" "}
            <a href="https://determined-mclean-cdf2de.netlify.app/">
              https://determined-mclean-cdf2de.netlify.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: josh.tummala@gmail.com</li>
      </ul>
    </div>
  );
};
